...
class OrderData(BaseData):
    ...
    def __str__(self):
        return f"{self.exchange.value}.{self.symbol} : {self.direction.value} {self.offset.value} {self.type.value} {self.volume} @ {self.price} order: {self.orderid} = {self.status.value}"
...
class OrderRequest:
    ...
    def __str__(self):
        return f"{self.exchange.value}.{self.symbol} : {self.direction.value} {self.offset.value} {self.type.value} {self.volume} @ {self.price} {self.reference} "
